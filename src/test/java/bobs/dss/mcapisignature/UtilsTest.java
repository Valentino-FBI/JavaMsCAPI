...
public class UtilsTest {
    ...
    public void testIssuerCertificate() {
        ...
        Structures.CERT_CONTEXT cert = CertUtils.findCertByHash("D525114F7A061BA0BC83D94646AE95F855931175");
...
@Test
    public void testGetChain() {
        ...
        Structures.CERT_CONTEXT cert = CertUtils.findCertByHash("2846742c664850c88ba76468eaa284f6a609e543");
        List<String> chain=CertUtils.getChain(cert);
        System.out.println(chain.size());
        int i=0;
        for (String certCA: chain){
            i++;
            dump(certCA.getBytes(),i+".cer");
        }
    }
    @Test
